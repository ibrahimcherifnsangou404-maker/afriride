...
import {
  ...
  Paperclip, Search, Send, SlidersHorizontal, Square, Star,
          ...
          <div className="flex gap-4 h-[calc(100vh-160px)] min-h-[500px]">
            ...
            `}>
              ...
              <div className="p-4 border-b border-white/5">
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-500 mb-3">Nouvelle conversation</p>
              ...
              <div className="px-4 pt-4 pb-2">
                <div className="relative mb-3">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/8 rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-slate-600 focus:bg-white/8 focus:border-emerald-500/40 transition-all"
                  />
                </div>
